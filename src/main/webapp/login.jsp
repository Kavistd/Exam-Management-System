              ...
              <div class="row gy-3 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="uid" id="email" placeholder="name@example.com" required>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                  <a href="customerinsert.jsp" class="link-secondary text-decoration-none">Create new account</a>
